    ...
    <div className="overflow-hidden">
      <div className="flex justify-between overflow-hidden h-screen  ">
        <div className="prosto-one-regular ml-[7vw]  leading-snug ">
          <h1>Start Saving</h1>
          <h1>Today, Simplify</h1>
          <h1>Your Finances</h1>

          <h3 className="poppins-semibold normal-case">
            Feeling overwhelmed by your finances? Discover an efficient 
            way of <br />  saving money that will also simplify managing your budget.
          </h3>
